//! UNC 작업 디렉터리 장벽 — **없는 실패를 지어내지 않는다** (state-machine 55절).
//!
//! # 무엇이 거짓말이었나
//!
...
/// 우리가 만들면 태스크가 죽었을 때 사용자 탐색기에 우리 흔적이 남는다(55.3절).
...
mod tests {
    ...
    /// 배너가 말해야 하는 네 가지(55.4절): 무엇이 안 도는가 · 무엇은 되는가 ·
